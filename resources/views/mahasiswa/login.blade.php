    ...
    <div class="bg-blue-100 p-8 rounded-lg shadow-lg w-96">
        ...
        <form action="/" method="POST" class="space-y-4">
            <div>
                ...
                <input type="text" name="username" placeholder="masukkan npm..." 
            ...
            <div class="flex justify-center">
                <a href="/mahasiswa/dashboard" class="btn w-full text-center bg-blue-500 text-white p-3 rounded hover:bg-blue-700">
                    LOGIN
                </a>
            </div>
