        ...
        <div class="flex-1 ml-64">
            ...
            <main class="p-6">
                ...
                <div class="bg-green-600 text-white p-3 text-center rounded mb-4 shadow-md w-full">
                    <h2 class="text-2xl font-bold">DATA DOSEN POLITEKNIK NEGERI CILACAP</h2>
                </div>
                <hr><br>
                ...
                <div class="bg-white shadow-md rounded p-4 max-w-4xl mx-auto overflow-x-auto">
                    <div class="flex justify-between items-center mt-4">
                        <a href="/admin/tambahDosen" class="bg-green-900 text-white px-4 py-2 rounded">
                            Tambah
                        </a>                        
                        <input type="text" placeholder="cari nip dosen..." class="border p-2 rounded">
                    </div>
                    <table class="w-full mt-4 border-collapse border border-gray-300 text-center">
                        ...
                        <tbody>
                            <tr class="text-center">
                                ...
                                <td class="border p-2">5432567876543</td>
                                <td class="border p-2">Karrel Davian Andara</td>>
                                <td class="border p-2">
                                    <a href="/admin/editDosen" class="text-blue-500">✏</a>
                                    <form action="/admin/hapusDosen/1" method="POST" onsubmit="return confirmDelete(event)">
