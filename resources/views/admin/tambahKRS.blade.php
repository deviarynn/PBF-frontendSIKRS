...
<head>
    ...
    <title>SiKRS - Tambah Data KRS Mahasiswa</title>
        ...
        <div class="flex-1 ml-64">
            ...
            <main class="p-6">
                ...
                <div class="flex justify-center items-center h-full">
                    ...
                    <h2 class="text-lg font-bold text-center">Tambah Data KRS</h2>
                      <div class="bg-white p-4 rounded-lg mt-4 text-black">
                        <form action="{{ route('admin.dataKRS.store') }}" method="POST">
                          @csrf

                          <!-- NPM (Dropdown) -->
                          <label for="npm" class="block font-semibold">NPM</label>
                          <select name="npm" id="npm" class="w-full border rounded p-2" required>
                          ...
                          <!-- Kode Matkul (Dropdown) -->
                          <label for="kode_matkul" class="block font-semibold mt-4">Mata Kuliah</label>
                              <select name="kode_matkul" id="kode_matkul" class="w-full border rounded p-2" required>
