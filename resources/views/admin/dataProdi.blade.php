            ...
            <main class="p-6">
                ...
                <div class="bg-white shadow-md rounded p-4 max-w-4xl mx-auto overflow-x-auto">
                    <div class="flex justify-between items-center mt-4">
                        ...
                        <input type="text" placeholder="cari prodi..." class="border p-2 rounded">
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border border-gray-400 px-4 py-2 text-center">
                                    <a href="/admin/editProdi/{{ $p['kode_prodi'] }}" class="text-blue-500">✏</a>
                                    <a href="/admin/deleteProdi/{{ $p['kode_prodi'] }}" class="text-red-500 ml-2">🗑</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
