        ...
        <div class="flex-1 ml-64">
            ...
            <main class="flex-1 p-6">
                <div class="flex justify-center items-center h-full">
                    <div class="bg-gray-900 text-black w-96 rounded-lg shadow-lg p-6">
                        ...
                        <div class="bg-white p-4 rounded-lg mt-4">
                            ...
                            <input type="text" placeholder="Contoh: TI-2C" class="w-full border border-gray-400 rounded p-2 mt-1">
                ...
                <div class="absolute left-100 bottom-0 ml-4 mb-4">
                    <a href="/admin/dataKelas" class="bg-yellow-700 text-white py-2 px-4 rounded-lg block text-center">Back</a>
                </div>
            </main>
            </div>
        </div>
